...
DEBUG: [start_http_server] Listening to port 3333
DEBUG: Draw.io MCP Server HTTP/SSE started
...
```
DEBUG: [sse_handler] A SSE client #0 connected, presumably MCP Extension!
```
